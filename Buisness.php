...
global $conn;
if ($stmt = $conn->prepare("SELECT gig_id, user_id, category_id, description, price, img, deliverytime, created_at, updated_at, language from advertisement WHERE category_id = 7")) {
  $result = $stmt->execute();
...
<h2 class="text-center text-primary">Buisness</h2>
<hr>
<div class="container">
